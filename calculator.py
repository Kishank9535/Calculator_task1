...
btn_mul=tk.Button(root,text="*",command=lambda: add_calc("*"),width=5,font=("Arial",14))
btn_mul.grid(row=4,column=4)
btn_div=tk.Button(root,text="/",command=lambda: add_calc("/"),width=5,font=("Arial",14))
btn_div.grid(row=5,column=4)
btn_01=tk.Button(root,text="(",command=lambda: add_calc("("),width=5,font=("Arial",14))
btn_01.grid(row=5,column=1)
btn_02=tk.Button(root,text=")",command=lambda: add_calc(")"),width=5,font=("Arial",14))
btn_02.grid(row=5,column=3)
btn_03=tk.Button(root,text="C",command=clear,width=11,font=("Arial",14))
btn_03.grid(row=6,column=1,columnspan=2)
btn_04=tk.Button(root,text="=",command=eval_calc ,width=11,font=("Arial",14))
btn_04.grid(row=6,column=3,columnspan=2)
root.mainloop()